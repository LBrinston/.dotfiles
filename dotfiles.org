...
#+begin_src yaml :tangle ~/.config/xremap/config.yml
modmap:
  - name: main remaps
    remap:
     rightalt: rightctrl
...
#+begin_src conf :tangle ~/.config/systemd/user/xremap.service
[Unit]
Description=Xremap
...
#+begin_src conf :tangle ~/.config/autostart/xremap.desktop
[Desktop Entry]
Name=Xremap
Type=Application
