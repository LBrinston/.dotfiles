...
It would be nice if all of our images automagically went to a consistent place (a ~./images~) with a subdir named for the org file we're inserting into.
